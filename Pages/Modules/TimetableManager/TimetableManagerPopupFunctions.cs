...
using Ui = TAF_iSAMS.Pages.Modules.TimetableManager.TimetableManagerPopupUIMap;


namespace TAF_iSAMS.Pages.Modules.TimetableManager
{
    public class TimetableManagerPopupFunctions : ModuleBasePage
    {

        // Store a reference to the page object that opened this popup.
        private readonly TimetableManagerFunctions _parentPage;
        ...
        private TimetableManagerPopupFunctions(IPage page, TimetableManagerFunctions parent)
        ...
        public static async Task<TimetableManagerPopupFunctions> CreateAsync(IPage page, TimetableManagerFunctions parent)
        {
            var instance = new TimetableManagerPopupFunctions(page, parent);
        ...
        public async Task<TimetableManagerFunctions> SaveAndReturnToMainWindow()
        {
            TimetableManagerFunctions timetableManagerPage = null;
            TestContext.WriteLine("Acting: Saving popup and returning to parent.");
            try
            {
                timetableManagerPage = await SaveAndReturnToParentAsyncDialog();
        ...
        public async Task<TimetableManagerFunctions> SaveAndReturnToParentAsync()
        {
        ...
        /// </summary>
        /// <returns>The parent Functions page object instance.</returns>
        public async Task<TimetableManagerFunctions> CloseWindowAndReturnToParentAsync()
        {
        ...
        /// </summary>
        /// <returns>The parent Functions page object instance.</returns>
        public async Task<TimetableManagerFunctions> SaveAndReturnToParentAsyncDialog()
        {
        ...
        /// </summary>
        /// <returns>The parent Functions page object instance.</returns>
        public async Task<TimetableManagerFunctions> CloseWindowAndReturnToParentAsyncDialog()
        {
            return await ClickElementCloseAndWaitForParentAsync("");
        }
        ...
        /// <returns>The parent Functions page object instance.</returns>
        private async Task<TimetableManagerFunctions> ClickElementCloseAndWaitForParentAsync(string locator, int timeoutMilliseconds = DefaultPopupTimeout)
        {
        ...
        public async Task<TimetableManagerFunctions> SelectFieldAndReturnToMainWindow()
        {
            ...
            await UpdateTextElement(Ui.TimetableDayDisplayName, Ui.TimetableDayDisplayNameValue, navigatorType);
        ...
        public async Task<TimetableManagerFunctions> SelectTimetableWeekFieldsAndReturnToMainWindow()
        {
            var navigatorType = NavigationHandler.ContentNavigator != null ? NavigatorTypes.Types.Content : NavigatorTypes.Types.Page;
            ...
            await UpdateTextElement(Ui.TimetableWeekDisplayName, Ui.TimetableWeekDisplayNameValue, navigatorType);
            await UpdateTextElement(Ui.TimetableWeekDisplayShortName, Ui.TimetableWeekDisplayShortNameValue, navigatorType);
            await ClickElement(Ui.SaveButton, navigatorType);
        ...
        public async Task<TimetableManagerFunctions> SelectTimetablePeriodFieldsAndReturnToMainWindow()
        {
            var navigatorType = NavigationHandler.ContentNavigator != null ? NavigatorTypes.Types.Content : NavigatorTypes.Types.Page;
            ...
            await UpdateTextElement(Ui.TimetablePeriodDisplayName, Ui.TimetablePeriodDisplayNameValue, navigatorType);
            await UpdateTextElement(Ui.TimetablePeriodDisplayShortName, Ui.TimetablePeriodDisplayShortNameValue, navigatorType);
            await UpdateTextElement(Ui.TimetablePeriodDisplayStartTime, Ui.TimetablePeriodDisplayStartTimeValue, navigatorType);
            await UpdateTextElement(Ui.TimetablePeriodDisplayEndTime, Ui.TimetablePeriodDisplayEndTimeValue, navigatorType);
        ...
        public async Task<TimetableManagerFunctions> EditTimetableWeekFieldsAndReturnToMainWindow()
        {
            var navigatorType = NavigationHandler.ContentNavigator != null ? NavigatorTypes.Types.Content : NavigatorTypes.Types.Page;
            ...
            await UpdateTextElement(Ui.TimetableWeekDisplayName, Ui.TimetableWeekDisplayNameEditValue, navigatorType);
 
            ////////////////////////////////////////////////////////////////
            // THE TEST IS CURRENTLY FAILING ON THE BELOW STEP.  THE TEST SAYS IT CLICKS THE 'SAVE & CLOSE' BUTTON BUT IN THE UI IT DOESN'T APPEAR TO CLICK THE BUTTON AS CLICKING THIS BUTTON
            // SHOULD GENERATE A SECOND POP UP.  WHEN MANUALLY CLICKING THE 'SAVE & CLOSE' BUTTON IT DOES GENERATE THIS SECOND POP UP WINDOW.
            ////////////////////////////////////////////////////////////////
            await ClickElement(Ui.SaveButton, navigatorType);
        ...
        public async Task<TimetableManagerFunctions> EditTimetablDayFieldsAndReturnToMainWindow()
        {
            var navigatorType = NavigationHandler.ContentNavigator != null ? NavigatorTypes.Types.Content : NavigatorTypes.Types.Page;
            ...
            await UpdateTextElement(Ui.TimetableDayDisplayName, Ui.TimetableDayDisplayNameEditValue, navigatorType);
            await ClickElement(Ui.SaveButton, navigatorType);
